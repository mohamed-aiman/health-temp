...
@include('components.heading', ['title' => 'Add a Business'])
	...
	<div class="columns">
		<div class="column">
			<div class="field">
			  ...
			  <div class="control">
			    <input class="input" name="name" type="text" placeholder="Business name">
			  </div>
			</div>
		</div>
		<div class="column">
			<div class="field">
			  ...
			  <div class="control">
			    <input class="input dhivehi" name="name_dv" type="text" placeholder="ދިވެހި ނަން">
			  </div>
			</div>
		</div>
		<div class="column">
