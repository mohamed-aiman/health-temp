...
@section('content')
@verbatim
<div v-can="'dhivehi-reports.show'">
@endverbatim
...
@verbatim
	<div class="container box no-print">
		<div class="columns dhivehi">
			<div class="column">
				<h3 class="title">ރިޕޯޓް ހަވާލުކުރުން</h3>
				<dhivehi-report-handover  :form="handoverForm" :id="reportId" @update="setHandoverForm"></dhivehi-report-handover>
			</div>
		</div>
	</div>
	...
	<div class="container box">
		<div class="columns dhivehi">
			<div class="column">
				<h1 class="title">ކާބޯތަކެތީގެ ޚިދުމަތްދޭ ތަން ތަން ބަލާ ފާސްކުރުމުގެ ރިޕޯޓް</h1>
			</div>
		</div>
		<div class="columns dhivehi">
			<div class="column">
		...
		<div class="columns dhivehi">
			<div class="column">
				<table class="table is-bordered">
					...
					<tr v-for="item in criticalPoints">
						<td>{{item.no}}</td>
		...
		<div class="columns dhivehi">
			<div class="column">
				<table class="table is-bordered">
					...
					<tr rowspan="2">
						<td colspan="3">ޤަވާޢިދާއި ޚިލާފް ވުމުން ކުރެވުނު ޖޫރިމަނާ ކުރެވުނު (ޖޫރިމަނާ ސްލިޕްގެ/ސްލޮޕްތަކުގެ ނަމްބަރު): &nbsp {{dhivehiReportForm.fine_slip_numbers}}</td>
					</tr>
				</table>
			</div>
		</div>
		...
		<div class="columns dhivehi">
			<div class="column">
				<table class="table is-bordered">
					...
					<tr><td>1. އިތުރު އިންސްޕެކްޝަނެއް ހެދުމަށް ފެނޭ &nbsp<input type="checkbox" disabled v-model="dhivehiReportForm.tobacco_conclusion_1">އިނސްޕެކްޓް ކުރަން ހުޝަހަޅާ ތާރީޚް<input type="text" disabled v-model="dhivehiReportForm.tobacco_conclusion_1_date"></td></tr>
...
<script type="text/javascript" src="{{mix('/js/dhivehi-reports-handover.js')}}"></script>
@endsection
