...
@include('components.heading', ['title' => 'Draft Applications'])
@verbatim
<div v-can="'applications.draftApi'">
	<div>
		<table class="table">
			<thead>
				<tr>
			...
			<tbody>
				<tr v-for="item,key in applications">
					...
					<td>
	                  	<p class="buttons">
						  <a class="button is-warning" v-can="'applications.edit'" @click="processItem(item)">
...
<script type="text/javascript" src="{{mix('/js/applications-draft.js')}}"></script>
@endsection