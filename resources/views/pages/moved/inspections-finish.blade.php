...
@section('content')
@include('components.heading', ['title' => 'Closing Inspection of ' . $inspection->business->name . ' (id:' . $inspection->id . ')'])
						...
						<table class="table is-narrow is-bordered is-fullwidth">
							...
							<tbody>
								<tr>
									...
									<td><a :href="'/inspections/' + inspection.follow_up_inspection.follow_up_id">{{inspection.follow_up_inspection.follow_up_id}}</a></td>
...
<script type="text/javascript" src="{{mix('/js/inspections-finish-page.js')}}"></script>
@endsection