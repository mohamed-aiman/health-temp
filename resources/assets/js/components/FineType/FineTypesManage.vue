<template>
	<div>
			...
			<div class="columns">
				<div class="column">
					<div class="field is-grouped">
					  <div class="control">
		 					  <button v-can="'api.fine-types.store'" v-if="!openForm" @click="switchOpenCloseForm" class="button is-success is-medium" >
		 					  	<span>New Fine Type</span>
							    <span class="icon is-small">
							      <i class="fa fa-plus"></i>
							    </span>
		 					  </button>
		 					  <button v-can="'api.fine-types.store'" v-if="openForm" @click="switchOpenCloseForm" class="button is-warning is-medium" >
		 					  	<span>Close Fine Type Form</span>
							    <span class="icon is-small">
		...
		<div v-can="'api.fine-types.store'" v-if="openForm">
			<div class="columns">
				<div class="column">
		...
		<div v-can="'fine-types.indexApi'">
			<div class="columns">
				<div class="column">
		            ...
		            <th class="dhivehi right">ކޯޑް</th>
		            <th class="dhivehi right">ނަމްބަރު</th>
		            <th class="dhivehi right" v-can="'fine-types.edit'">ބަދަލުގެނޭ</th>
						</tr>
