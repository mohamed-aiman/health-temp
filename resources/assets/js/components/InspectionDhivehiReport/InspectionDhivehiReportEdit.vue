...
<div v-can="'api.dhivehi-reports.update'">
    ...
    <div class="columns no-print">
        <div class="column dhivehi">
            <table class="table">
                <tr>
                    <td class="right">
                        <a class="button is-warning" v-can="'api.dhivehi-reports.update'" @click="saveDhivehiReportForm()">ރައްކާކުރޭ</a>
                        <a class="button is-warning" v-can="'api.dhivehi-reports.sendForProcessing'" @click="sendForProcessing()">ޕްރޮސެސިން އަށް ފޮނުވާ</a>
                        <router-link class="button is-info" v-can="'api.inspections.dhivehi-reports.show'" :to="{ name: 'dhivehi-reports.show', params: { reportId: reportId }}">ޕްރިންޓް ވިއު</router-link>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div>
        ...
        <br>
        <div class="columns" v-if="gradingCalculated.grade">
          <div class="column">
        ...
        <div class="columns dhivehi">
            <div class="column">
                <table class="table is-bordered">
                    ...
                    <tr><td>2. ސެކްސަން 2 ގައި ބަޔާންކުރެވިފައިވާ ކަންތައް<input type="number" name="food_conclusion_2_days" v-model="dhivehiReportForm.food_conclusion_2_days"> ދުވަހުގެ ތެރޭގައި ރަނގަޅުކުރަން އެންގުން &nbsp<input type="checkbox" name="food_conclusion_2" v-model="dhivehiReportForm.food_conclusion_2"></td></tr>
                    <tr><td>3. އިތުރު އިންސްޕެކްޝަނެއް ހެދުމަށް ފެނޭ &nbsp<input type="checkbox" name="food_conclusion_3" v-model="dhivehiReportForm.food_conclusion_3">އިނސްޕެކްޓް ކުރަން ހުޝަހަޅާ ތާރީޚް<input type="text" name="food_conclusion_3_date" v-model="dhivehiReportForm.food_conclusion_3_date"></td></tr>
                    <tr><td>4. ތަން ބަންދުކުރުމަށް ފެނޭ &nbsp<input type="checkbox" name="food_conclusion_4" v-model="dhivehiReportForm.food_conclusion_4"></td></tr>
                    <tr><td>5. އެޕްލިކޭޝަން ބާތިލްވެފައިވާތީ އަލުން ހުށަހެޅުމަށް &nbsp<input type="checkbox" name="food_conclusion_5" v-model="dhivehiReportForm.food_conclusion_5"></td></tr>
                    <tr><td>6. ހުއްދައިގެ / ޖުރުމަނާ ފައިސާ (އަދަދު:<input type="text" name="food_conclusion_6_amount" v-model="dhivehiReportForm.food_conclusion_6_amount">) ދެއްކި ކަމުގެ ރަސީދު އެޓޭޗް ކުރެވިފައި &nbsp<input type="checkbox" name="food_conclusion_6" v-model="dhivehiReportForm.food_conclusion_6"></td></tr>
                    ...
                    <tr><td>1. އިތުރު އިންސްޕެކްޝަނެއް ހެދުމަށް ފެނޭ &nbsp<input type="checkbox" name="tobacco_conclusion_1" v-model="dhivehiReportForm.tobacco_conclusion_1">އިނސްޕެކްޓް ކުރަން ހުޝަހަޅާ ތާރީޚް<input type="text" name="tobacco_conclusion_1_date" v-model="dhivehiReportForm.tobacco_conclusion_1_date"></td></tr>
                    <tr><td>2. އެޕްލިކޭޝަން ބާތިލްވެފައިވާތީ އަލުން ހުށަހެޅުމަށް &nbsp<input type="checkbox" name="tobacco_conclusion_2" v-model="dhivehiReportForm.tobacco_conclusion_2"></td></tr>
                    <tr><td>3. ހުއްދައިގެ / ޖުރުމަނާ ފައިސާ (އަދަދު:<input type="text" name="tobacco_conclusion_3_amount" v-model="dhivehiReportForm.tobacco_conclusion_3_amount">) ދެއްކި ކަމުގެ ރަސީދު އެޓޭޗް ކުރެވިފައި &nbsp<input type="checkbox" name="tobacco_conclusion_3" v-model="dhivehiReportForm.tobacco_conclusion_3"></td></tr>
                </table>
            </div>
        </div>
        <br>
...
export default {
    ...
    methods: {
        ...
        sendForProcessing() {
          if (this.hasPermission('api.dhivehi-reports.sendForProcessing')) {
            axios
        ...
        getReport() {
          if (this.hasPermission('api.inspections.dhivehi-reports.show')) {
            axios.get('/api/inspections/' + this.inspectionId + '/dhivehi/reports/')
            .then(response => {
        ...
        setDhivehiReportFormFromResponse(data) {
            ...
            this.gradingCalculated = data.grading;
        },
        ...
        saveDhivehiReportForm() {
          if (this.hasPermission('api.dhivehi-reports.update')) {
        ...
        storePoint(type) {
          if (this.hasPermission('api.dhivehi-reports.form-points.store')) {
        ...
        updatePoint(type, point) {
          if (this.hasPermission('api.dhivehi-reports.form-points.update')) {
        ...
        removePoint(type, point) {
          if (this.hasPermission('api.dhivehi-reports.form-points.destroy')) {
        ...
        refreshPointsBlock(type) {
          if (this.hasPermission('api.dhivehi-reports.form-points.index')) {
            axios.get('/api/dhivehi-reports/'+this.reportId+'/points?type=' + type)
                .then((response) => {
                    switch(type) {
                      case 'CR':
                        this.criticalPoints = response.data;
                        break;
                      case 'MJ':
                        this.majorPoints = response.data;
                        break;
                      case 'MN':
                        this.minorPoints = response.data;
                        break;
                      default:
                    }
                })
