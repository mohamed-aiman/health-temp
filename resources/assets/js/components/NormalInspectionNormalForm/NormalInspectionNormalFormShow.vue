<template>
	<div v-can="'api.normal-inspections.normalforms.show'">
		...
		<div class="columns no-print">
			<div class="column dhivehi">
				<table class="table">
					<tr>
						<td class="right">
							<!-- <a v-if="normalForm.status == 'draft'" class="button is-warning"  v-can="'api.inspections.changedStatusToOngoing'" @click="startFillingChecklist()">ޗެކްލިސްޓް ފުރުމަށް</a> -->
		...
		<div>
	        ...
	        <div class="columns dhivehi" v-if="gradingCalculated.grade">
	          <div class="column">
...
export default {
    ...
    methods: {
	    ...
	    getGradingsCalculated() {
        	if (this.hasPermission('api.normal-forms.gradings') && this.normalFormId) {
	           axios
              .get('/api/normalforms/' + this.normalFormId + '/gradings')
                .then(response => {
